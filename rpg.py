...
#Enemy Movement
def enemyMove(enem1, enem2):
    global playerPhase

    if not playerPhase:
        #Enemy1 Attack Animation

        #attack based off rng
        #after animation is done, then goes to enemy 2

        #enemy2
        #after animation is done, then player phase begins
...
while 1:
    ...
    surface.blit(mainCharacter,(character1.left-60, character1.top-100)) #

    characterMove(character1, character2)
    enemyMove(enemy1, enemy2)
